    ...
    <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
        ...
        <a href="{{ route('admin.dashboard') }}">
            <span class="logo" :class="sidebarToggle ? 'hidden' : ''">
                <img class="dark:hidden" src="{{ asset('backend/tailwind/src/images/logo/logo.svg') }}" alt="Logo" />
                <img class="hidden dark:block" src="{{ asset('backend/tailwind/src/images/logo/logo-dark.svg') }}"
                    alt="Logo" />
            </span>

            <img class="logo-icon" :class="sidebarToggle ? 'lg:block' : 'hidden'"
                src="{{ asset('backend/tailwind/src/images/logo/logo-icon.svg') }}" alt="Logo" />
        </a>
    </div>
    <!-- SIDEBAR HEADER -->
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'Dashboard' ? '':'Dashboard')"
                            class="menu-item group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium text-gray-700 duration-300 ease-in-out hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-800"
                            ...
                            <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                :class="[(selected === 'Dashboard') ? 'rotate-180' : '',
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                ...
                                <li>
                                    <a href="{{ route('admin.dashboard') }}"
                                        class="menu-dropdown-item group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium text-gray-700 duration-300 ease-in-out hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-800"
                                        :class="page === 'ecommerce' ? 'bg-gray-100 dark:bg-gray-800' : ''">
                                        eCommerce
                                    </a>
                                </li>
                            </ul>
