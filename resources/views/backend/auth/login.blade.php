...
<head>
    ...
    <title>Sign In | Procurement</title>
...
<body x-data="{ darkMode: false, showPassword: false }" x-init="darkMode = JSON.parse(localStorage.getItem('darkMode') || 'false');
                        ...
                        <div>
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        <button type="submit"
                                            class="w-full px-4 py-3 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors">
                                            Sign In
                                        </button>
                                    </div>
                                </div>
                ...
                <div class="flex items-center justify-center z-1">
                    <div class="flex flex-col items-center max-w-xs">
                        <a href="{{ url('/') }}" class="block mb-4">
                            <h1 class="text-2xl font-bold text-white">Procurement</h1>
                        </a>
