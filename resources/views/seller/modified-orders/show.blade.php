@extends('seller.layouts.seller', ['pageTitle' => 'Modified Orders', 'breadcrumbTitle' => 'Modified Orders', 'breadcrumbRoute' => 'modified-orders.index', 'breadcrumbCurrent' => 'view'])

@section('title', 'View Modified Order | Procurement Dashboard')

@section('content')

    <div class="container-fluid px-6 mt-4 mx-auto grid">
                ...
                <button
                    ...
                    <div class="p-1 mr-1 rounded-full text-red-600">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="w-5 h-5 text-red-600 hover:text-red-600 cursor-pointer" viewBox="0 0 24 24"
