...
@section('content')
    ...
    <div
        ...
        <div class="relative max-w-sm w-full">
            ...
            <input
                class="w-full max-w-xl pl-10 pr-4 py-2 text-sm text-gray-700 placeholder-gray-500 border-gray-300 rounded-lg dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-1
                                00 focus:placeholder-gray-500 focus:bg-white focus:outline-none focus:border-gray-800 focus:ring-1 focus:ring-gray-800 form-input"
                ...
                <tbody
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3 flex items-center justify-center dark:border-gray-700">
                            <button onclick="window.location.href='edit-enquiry-quote.html'"
