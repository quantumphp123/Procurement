   <div
       ...
       <!-- Search + Filter -->
       <div class="flex flex-wrap md:flex-nowrap items-center gap-4 ml-auto min-w-0 w-full md:w-auto">
           <!-- Search Box -->
           <div class="relative max-w-xs w-full min-w-0">
               <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                   <img src="assets/img/icons/search-icon.svg" alt="search-icon" height="20" />
               </div>
               <input
                   ...
                   type="text" placeholder="Search enquiry number" aria-label="Search" />
           </div>
           <!-- Dropdown -->
           <div class="relative flex-shrink-0 min-w-[130px]" x-data="{
               open: false,
               selected: '1 Week Ago',
               options: ['Today', '1 Week Ago', '1 Month Ago'],
               openUpward: false,
               toggleDropdown(el) {
                   this.open = !this.open;
                   if (this.open) {
           ...
           }" x-init="$watch('open', val => { if (!val) openUpward = false })">
               <button @click="toggleDropdown($el)" :aria-expanded="open.toString()" aria-haspopup="listbox"
                   class="flex items-center justify-between w-full px-4 py-2 text-sm border border-gray-300 dark:border-gray-700 rounded-md text-gray-900 dark:text-gray-200 bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center justify-between min-w-[130px]">
               ...
               <ul x-show="open" @click.outside="open = false"
                   ...
                   class="absolute left-0 right-0 z-10 w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md shadow-lg transition-all duration-150 ease-out origin-top"
                   ...
                   <template x-for="option in options" :key="option">
                       <li @click="selected = option; open = false" x-text="option"
                           ...
                           :class="{
                               'bg-gray-200 dark:bg-gray-700 font-semibold text-gray-900 dark:text-white': selected ===
                                   option,
                               'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700': selected !==
                                   option
                           }"
                           role="option" :aria-selected="selected === option"></li>
                   </template>
               </ul>
           </div>
       </div>
   ...
   <div class="w-full overflow-hidden bg-white px-4 py-5 dark:bg-gray-900">
               ...
               <tbody
                   ...
                   <tr>
                       ...
                       <td class="px-4 py-3 flex items-center justify-center dark:border-gray-700">
                           <button title="View Enquiry" onclick="window.location.href='view-quote.html'"
       ...
       <div
           ...
           <div
               ...
               <span class="font-semibold">Showing 2 to 8 of 50 entries</span>
               <div class="relative hidden md:flex" x-data="{
                   dropdownOpen: false,
                   dropdownOption: 'Show 8',
